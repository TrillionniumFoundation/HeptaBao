...
fn opaque_identity_alias_requires_schema23_without_native_ldap_configuration() -> TestResult {
    ...
    older.auth.remove_name_modes_for_legacy_format_test();
    older.schema = 22;
...
fn native_ldap_cidr_issued_token_survives_config_clear_and_durable_restart() -> TestResult {
    ...
    historical.auth.remove_name_modes_for_legacy_format_test();
    ...
    configured.auth.remove_name_modes_for_legacy_format_test();
