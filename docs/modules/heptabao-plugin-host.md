...
| `fn` | `revoke_prefix` | `crates/heptabao-plugin-host/src/durable.rs:391` | `pub fn revoke_prefix(` |
...
| `fn` | `revoke_prefix` | `crates/heptabao-plugin-host/src/lib.rs:679` | `pub fn revoke_prefix(` |
