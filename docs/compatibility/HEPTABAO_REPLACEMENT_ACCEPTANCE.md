...
| PKI extension configuration | `pkiext_live.py` | Persisted `config/cluster` and `config/acme` on the existing PKI engine, with hostile input rejection; ACME protocol routes remain open. |
...
| `HB-SURFACE-SECRET-PKIEXT` | `secret_engines` | `IMPLEMENTED_SCOPED` | `pkiext_live.pkiext.mount`, `pkiext_live.pkiext.unauthorized_denied`, `pkiext_live.pkiext.cluster_config`, `pkiext_live.pkiext.acme_config`, `pkiext_live.pkiext.acme_config_read`, `pkiext_live.pkiext.invalid_cluster_rejected`, `pkiext_live.pkiext.unknown_field_ignored_with_warning`, `pkiext_live.pkiext.known_field_persists_after_unknown`, `pkiext_live.pkiext.cluster_persists_after_restart`, `pkiext_live.pkiext.acme_persists_after_restart` |
...
| `HB-SURFACE-PROFILES-WORKFLOWS` | `namespace_workflow` | `IMPLEMENTED_SCOPED` | `workflow_profile_live.tls_initialize`, `workflow_profile_live.tls_unseal`, `workflow_profile_live.input_write`, `workflow_profile_live.profile_create`, `workflow_profile_live.profile_read`, `workflow_profile_live.run_succeeds`, `workflow_profile_live.run_response_redacted`, `workflow_profile_live.duplicate_replay_same_run`, `workflow_profile_live.duplicate_replay_no_new_version`, `workflow_profile_live.output_write_exact`, `workflow_profile_live.run_status_readback`, `workflow_profile_live.ssrf_profile_rejected`, `workflow_profile_live.path_escape_rejected`, `workflow_profile_live.unknown_action_rejected`, `workflow_profile_live.secret_output_rejected`, `workflow_profile_live.caller_identity_rejected`, `workflow_profile_live.payload_bound`, `workflow_profile_live.cross_namespace_rejected`, `workflow_profile_live.reconcile_is_inspect_only`, `workflow_profile_live.restart_sealed`, `workflow_profile_live.restart_unseal`, `workflow_profile_live.restart_run_readback`, `workflow_profile_live.restart_output_readback` |
