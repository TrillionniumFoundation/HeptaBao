...
| `HB-SURFACE-AUTH-KERBEROS` | `auth_methods` | `IMPLEMENTED_SCOPED` | `kerberos_mit_live.config_roundtrip`, `kerberos_mit_live.real_mit_ap_req_login`, `kerberos_mit_live.replayed_negotiation_denied`, `kerberos_mit_live.wrong_realm_denied`, `kerberos_mit_live.wrong_service_identity_denied`, `kerberos_mit_live.expired_ticket_denied`, `kerberos_mit_live.clock_skew_denied`, `kerberos_mit_live.restart_replay_denied`, `kerberos_mit_live.restart_native_cache_is_fresh`, `kerberos_mit_live.cross_namespace_replay_denied`, `kerberos_mit_live.restart_fresh_ticket_still_works` |
...
| `HB-SURFACE-SECRET-RABBITMQ` | `secret_engines` | `IMPLEMENTED_SCOPED` | `rabbitmq_live.real_rabbitmq_4_1_ready`, `rabbitmq_live.rabbitmq_public_mount_type`, `rabbitmq_live.rabbitmq_unbound_vhost_rejected`, `rabbitmq_live.rabbitmq_plugin_configuration_readback`, `rabbitmq_live.rabbitmq_dynamic_user_reaches_provider`, `rabbitmq_live.rabbitmq_issued_user_is_not_administrator`, `rabbitmq_live.rabbitmq_exact_vhost_permissions`, `rabbitmq_live.rabbitmq_foreign_vhost_denied`, `rabbitmq_live.rabbitmq_issued_login_is_real`, `rabbitmq_live.rabbitmq_dynamic_credential_renew_reaches_provider`, `rabbitmq_live.rabbitmq_provider_state_survives_restart`, `rabbitmq_live.rabbitmq_service_state_survives_restart`, `rabbitmq_live.rabbitmq_revoke_removes_provider_user`, `rabbitmq_live.rabbitmq_outage_retains_revoke_intent`, `rabbitmq_live.rabbitmq_restart_reconciles_pending_revoke` |
...
| `HB-SURFACE-DB-CASSANDRA` | `database_providers` | `IMPLEMENTED_SCOPED` | `cassandra_live.real_cassandra_5_ready`, `cassandra_live.cassandra_plugin_configuration_readback`, `cassandra_live.cassandra_readonly_issue_reaches_provider`, `cassandra_live.cassandra_readonly_select_succeeds`, `cassandra_live.cassandra_readonly_write_denied`, `cassandra_live.cassandra_readwrite_mutation_succeeds`, `cassandra_live.cassandra_dynamic_credential_renew_reaches_provider`, `cassandra_live.cassandra_provider_state_survives_restart`, `cassandra_live.cassandra_service_state_survives_restart`, `cassandra_live.cassandra_revoke_removes_provider_login`, `cassandra_live.cassandra_outage_retains_revoke_intent`, `cassandra_live.cassandra_restart_reconciles_pending_revoke` |
| `HB-SURFACE-DB-INFLUXDB` | `database_providers` | `IMPLEMENTED_SCOPED` | `influxdb_live.real_influxdb_1_8_ready`, `influxdb_live.influxdb_unbound_database_rejected`, `influxdb_live.influxdb_plugin_configuration_readback`, `influxdb_live.influxdb_readonly_issue_reaches_provider`, `influxdb_live.influxdb_readonly_query_succeeds`, `influxdb_live.influxdb_ungranted_database_denied`, `influxdb_live.influxdb_readonly_write_denied`, `influxdb_live.influxdb_dynamic_credential_renew_reaches_provider`, `influxdb_live.influxdb_provider_state_survives_restart`, `influxdb_live.influxdb_service_state_survives_restart`, `influxdb_live.influxdb_revoke_removes_provider_login`, `influxdb_live.influxdb_outage_retains_revoke_intent`, `influxdb_live.influxdb_restart_reconciles_pending_revoke` |
...
| `HB-SURFACE-PROFILES-WORKFLOWS` | `namespace_workflow` | `IMPLEMENTED_SCOPED` | `workflow_live.initialize`, `workflow_live.unseal`, `workflow_live.mount_local_kv`, `workflow_live.manage_create_cas_zero`, `workflow_live.manage_list_root`, `workflow_live.manage_list_prefix`, `workflow_live.manage_get_versioned_definition`, `workflow_live.execute_sequential_local_steps`, `workflow_live.cas_create_only_rejects_overwrite`, `workflow_live.external_url_rejected`, `workflow_live.allow_unauthenticated_rejected`, `workflow_live.recursive_workflow_rejected`, `workflow_live.unauthenticated_execution_denied`, `workflow_live.manage_stop_definition`, `workflow_live.stop_on_failed_step`, `workflow_live.failed_step_has_no_following_effect`, `workflow_live.manage_allow_failure_definition`, `workflow_live.allow_failure_continues`, `workflow_live.namespace_create`, `workflow_live.namespace_scoped_management`, `workflow_live.namespace_scoped_isolation`, `workflow_live.restart_starts_sealed`, `workflow_live.restart_unseal`, `workflow_live.workflow_survives_restart`, `workflow_live.delete_cas`, `workflow_live.delete_readback` |
...
OpenBao 2.6.2 `builtin/logical/pkiext` is a test-only package used to split Docker PKI tests from the main PKI test suite; it has no non-test target and therefore is not a separate compatibility surface. Its behavioral coverage belongs to `HB-SURFACE-SECRET-PKI`.
