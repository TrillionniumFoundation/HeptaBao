...
| `HB-SURFACE-SECRET-RABBITMQ` | `secret_engines` | `IMPLEMENTED_SCOPED` | `rabbitmq_live.real_rabbitmq_4_1_ready`, `rabbitmq_live.initialize`, `rabbitmq_live.unseal`, `rabbitmq_live.mount`, `rabbitmq_live.configuration`, `rabbitmq_live.configuration_readback`, `rabbitmq_live.manager_probe_queue`, `rabbitmq_live.role`, `rabbitmq_live.role_vhost_permission_enforcement`, `rabbitmq_live.role_readback`, `rabbitmq_live.default_deny_namespace_and_unauthorized`, `rabbitmq_live.real_user_issuance`, `rabbitmq_live.lease_lookup_readback`, `rabbitmq_live.issued_user_opens_configured_vhost`, `rabbitmq_live.issued_user_permission_denied`, `rabbitmq_live.issued_user_denied_unconfigured_vhost`, `rabbitmq_live.renewal_rejected_without_provider_semantics`, `rabbitmq_live.restart_is_sealed`, `rabbitmq_live.user_survives_heptabao_restart`, `rabbitmq_live.user_survives_rabbitmq_restart`, `rabbitmq_live.revoke_denies_new_connection`, `rabbitmq_live.revoke_closes_existing_connection`, `rabbitmq_live.outage_seed`, `rabbitmq_live.outage_seed_provider_login`, `rabbitmq_live.provider_outage_retains_pending_revoke`, `rabbitmq_live.restart_unseal_before_reconcile`, `rabbitmq_live.restart_reconciles_pending_revoke`, `rabbitmq_live.no_plaintext_secret_persistence` |
