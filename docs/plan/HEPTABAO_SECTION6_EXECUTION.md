...
| Storage/compatibility | Audited capacity API; 16 MiB chunk/manifest local state; pre-entry active-epoch check; authenticated replay-epoch retirement; journal checkpoint retry/fences; real TLS refusal/restart tests | Whole-state serialization, tighter 768 KiB HA proposal envelope, indexed/streaming transactional ownership, >32k and multi-host epoch qualification |
