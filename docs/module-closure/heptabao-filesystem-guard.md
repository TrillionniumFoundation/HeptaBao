# heptabao-filesystem-guard module closure dossier

This dossier is the independently reviewable design, boundary, failure-semantics, and acceptance record for **`heptabao-filesystem-guard`**. It is generated from the exact candidate tree and must be reviewed whenever the source or manifest hash changes. It does not grant compatibility, production, migration, or release authority.
...
The source-defined failure vocabulary is: `DirectoryGuardError::RootMustBeAbsolute`; `DirectoryGuardError::UnsupportedPlatform`; `DirectoryGuardError::UnsafeRoot`; `DirectoryGuardError::RootIdentityChanged`; `DirectoryGuardError::DescriptorPathUnavailable`; `DirectoryGuardError::WriterBusy`; `DirectoryGuardError::InvalidLeafName`; `DirectoryGuardError::Io`
...
- **Source/manifest evidence:** source tree SHA-256 `c8e01604327cfdf425db1a5edba272a8cdad3207d8d62138f4a2d048ecccc7e5`; manifest SHA-256 `a9ea4b0d9f7a5284049fbbb60a81509260c4e675ea04d5933468363738da9cb8`.
