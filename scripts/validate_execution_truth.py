...
def validate(root: Path = ROOT) -> list[str]:
    try:
        ...
        # Do not infer replay/epoch behavior from Rust source layout.  That
        # created false failures whenever rustfmt, validation, or harmless helper
        # extraction changed statement shape.  The behavioral invariant is owned
        # by compiled Service tests plus qa/openbao-acceptance/replay_epoch_ha.py,
        # both of which are mandatory in the exact-head qualification workflow.
        # This validator intentionally limits itself to execution-document truth.
        return problems
